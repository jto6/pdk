...
PDK_GTC_ROOT_PATH ?= $(pdk_PATH)
export PDK_GTC_COMP_PATH = $(PDK_GTC_ROOT_PATH)/ti/drv/gtc
...
PDM_UTILS_ROOT_PATH ?= $(pdk_PATH)
export PDM_UTILS_COMP_PATH = $(PDM_UTILS_ROOT_PATH)/ti/drv/pdm_utils
